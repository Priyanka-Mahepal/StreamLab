...
const Homepage = (props) => {
  ...
  const getbanner = () => {
    axios.get("https://wordpress.crescentek.co.uk/anand/streamlab/api/home")
      .then((data) => {
        console.log("axios", data.data.result);
        setBanner(data.data);
      })
    ...
    <div>
      {
        banner.result.map((value, i) => (
          <div className="homepage">
            ...
            <Carousel responsive={responsive} infinite={true}  autoPlaySpeed={6000}>
